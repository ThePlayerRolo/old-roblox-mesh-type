...
{
	// Initialization
	GDExtensionBool GDE_EXPORT RobloxMeshUtils_Library_Init(GDExtensionInterfaceGetProcAddress p_get_proc_address, GDExtensionClassLibraryPtr p_library, GDExtensionInitialization *r_initialization)
	{
